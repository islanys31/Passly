...
--
ALTER TABLE `equipos`
  ADD CONSTRAINT `equipos_fk_usuario` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`),
  ADD CONSTRAINT `equipos_fk_estado` FOREIGN KEY (`estado_id`) REFERENCES `estados` (`id`);
